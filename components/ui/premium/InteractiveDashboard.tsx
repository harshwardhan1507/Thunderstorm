...
import { Play, Pause, SkipForward, SkipBack, BarChart2, Code2, Layers } from "lucide-react";
          ...
          <div className="col-span-1 flex flex-col gap-4 md:col-span-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-white/5 bg-white/5 px-6 py-3">
              <div className="flex items-center gap-4">
                <button className="text-white/50 hover:text-white"><SkipBack size={18} /></button>
                <button 
                ...
                <button className="text-white/50 hover:text-white"><SkipForward size={18} /></button>
              </div>
