...
import { Play, Pause, SkipForward, SkipBack, Code2, Layers } from "lucide-react";
...
export function InteractiveDashboard() {
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto w-full max-w-5xl perspective-1000"
    >
      {/* Glow effect behind dashboard */}
      <div className="absolute -inset-1 rounded-3xl bg-gradient-to-b from-primary/50 to-purple-600/20 opacity-50 blur-2xl" />
      
      {/* Main dashboard window */}
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#0a0a0a]/90 shadow-2xl backdrop-blur-2xl">
          ...
          <div className="col-span-1 flex flex-col gap-4 md:col-span-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-white/5 bg-white/5 px-6 py-3">
              <div className="flex items-center gap-4">
                <button onClick={(e) => e.preventDefault()} className="text-white/50 hover:text-white transition-colors"><SkipBack size={18} /></button>
                <button 
                ...
                <button onClick={(e) => e.preventDefault()} className="text-white/50 hover:text-white transition-colors"><SkipForward size={18} /></button>
              </div>
