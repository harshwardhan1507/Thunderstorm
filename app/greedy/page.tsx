...
export default function GreedyPage() {
  return (
    <Suspense fallback={<div className="flex-1 flex items-center justify-center text-[#555555] font-mono text-xs">Loading Greedy Visualizer...</div>}>
      <GreedyPageInner />
    </Suspense>
  );
}
  ...
  return (
    <div className="flex-1 w-full px-6 py-6 flex flex-col select-none">
      ...
      <div className="text-xs text-[#555555] font-mono mb-4 flex items-center gap-1.5">
        ...
        <span>›</span>
        <span className="text-[#888888]">Greedy</span>
        <span>›</span>
      ...
      <div className={`flex flex-col gap-4 w-full ${activeTab === 'metrics' ? 'block' : 'hidden lg:block'}`}>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
          ...
          <div className="p-4 rounded-xl bg-[#141414] border border-[#2a2a2a] hover:border-[#333333] flex flex-col justify-between">
            <div className="flex items-center justify-between mb-2">
              ...
              <CheckSquare className="w-3.5 h-3.5 text-[#555555]" />
            </div>
          ...
          <div className="p-4 rounded-xl bg-[#141414] border border-[#2a2a2a] hover:border-[#333333] flex flex-col justify-between">
            <div className="flex items-center justify-between mb-2">
              ...
              <TreePine className="w-3.5 h-3.5 text-[#555555]" />
            </div>
            <div className="text-2xl font-black text-white font-mono leading-none mt-1">
        ...
        <div className="flex gap-2.5 mt-2 flex-wrap font-mono">
          <span className="px-3 py-1.5 rounded-lg bg-[#1c1c1c] border border-[#2a2a2a] text-xs font-semibold text-[#888888]">
            Activity Selection Complexity: <span className="text-[#22C55E]">O(N log N) time</span> · <span className="text-[#22C55E]">O(1) space</span>
          </span>
          <span className="px-3 py-1.5 rounded-lg bg-[#1c1c1c] border border-[#2a2a2a] text-xs font-semibold text-[#888888]">
            Huffman Tree Complexity: <span className="text-[#22C55E]">O(N log N) time</span> · <span className="text-[#22C55E]">O(N) space</span>
          </span>
        </div>
      </div>
